...
- (void)viewDidLoad
{
    ...
    [titleLab setTitle:@"钻石动态       " forState:UIControlStateNormal];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (cell==Nil) {
        ...
        UIImageView *sepImageView=[[UIImageView alloc] initWithFrame:CGRectMake(0, 78, 320, 2)];
...
{
    DongTaiDetailViewController *dongTaiDetailVC=[[DongTaiDetailViewController alloc] init];
    dongTaiDetailVC.selectType=0;
    [self.navigationController pushViewController:dongTaiDetailVC animated:YES];
}
